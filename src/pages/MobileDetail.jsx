...
//                     <div className="border flex justify-center items-center rounded-lg p-4 bg-white">
//                         <img
//                             src={mobById?.mobImg}
//                             alt="Product Image"
...
//                                             Processor
//                                         </div>
//                                         <div>{mobById?.chipset} Processor</div>
//                                     </div>
//                                     <div>
//                                         <div className="font-medium">
//                                             Display
//                                         </div>
//                                         <div>
//                                             {mobById?.display}inch HD+ display
//                                         </div>
//                                     </div>
//                                     <div>
//                                         <div className="font-medium">RAM</div>
//                                         <div>{mobById?.ram}GB RAM</div>
//                                     </div>
//                                     <div>
//                                         <div className="font-medium">
//                                             Camera
...
//             <div defaultValue="specs" className="w-full">
//                 <div>
//                     <div value="specs">Specifications</div>
//                     <div value="reviews">Reviews</div>
//                     <div value="compare">Compare</div>
//                 </div>
//                 <div value="specs">
//                     <div>
//                         <div className="p-6">
...
//                                             Releasing Date{" "}
//                                         </div>
//                                         <div>{mobById?.releaseDate}</div>
//                                     </div>
//                                     <div>
//                                         <div className="font-medium">
//                                             OS Type
//                                         </div>
//                                         <div>{mobById?.osType}</div>
//                                     </div>
//                                     <div>
//                                         <div className="font-medium">
//                                             Display Resolution
//                                         </div>
//                                         <div>{mobById?.displayRes}</div>
//                                         <div>
//                                             <div className="font-medium">
//                                                 Protection
//                                             </div>
//                                             <div>Ceramic Shield glass</div>
//                                         </div>
//                                         <div>
//                                             <div className="font-medium">
//                                                 Chipset
//                                             </div>
//                                             <div>{mobById?.chipset}</div>
//                                         </div>
//                                         <div>
//                                             <div className="font-medium">
//                                                 video Resoultion
//                                             </div>
//                                             <div>{mobById?.video}</div>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                             />
//                                         ))}
//                                         <div className="w-5 h-5 fill-muted stroke-muted-foreground" />
//                                     </div>
//                                     <span className="ml-2 text-muted-foreground">
//                                         4.3 out of 5
//                                     </span>
//                                 </div>
//                                 <p>Based on 1688 reviews</p>
//                             </div>
//                         </div>
//                     </div>
//                     <div value="compare">
//                         <div>
//                             <div className="p-6">
//                                 <p>Compare with other similar phones</p>
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="lg:col-span-4 lg:row-end-1">
            <div className="aspect-h-3 aspect-w-4 overflow-hidden rounded-lg bg-gray-100 flex justify-center items-center">
              <img src={mobById?.mobImg} alt={product.imageAlt} className="py-8 " width={400} />
            </div>
          </div>

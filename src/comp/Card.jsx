...
const Card = ({ info }) => {
	return (
		<div className="flex flex-row w-full gap-8 border-b-2 border-gray-400">
			...
			<div className="mr-4">
				...
				<div className="bg-green-500 text-white font-semibold text-lg rounded-xl w-fit px-3 py-0.5 mt-3 whitespace-nowrap cursor-pointer">
					Buy Now
				</div>
			</div>
		</div>
